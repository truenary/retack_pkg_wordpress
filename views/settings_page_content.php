<div class="main">
    ...
    <div class="banner">
        <img src="https://docs.retack.ai/wp-content/uploads/2024/08/retack_main_with_bar.png" alt="Retack Dashboard">
    </div>
    <div class="input-features">
        ...
        <div id="features">
			...
			<div class='border'></div>
                ...
                <li>🔔 Get Instant Error Alerts</li>
                <li>💡 Smart Insights</li>
                <li>🛠️ Code Fix Automation</li>
